...
// $ stream-adventure verify 13.duplexer.js
...
module.exports = function (cmd, args) {
    ...
    // Use duplexer to combine the stdin and stdout streams of 
    // the child process into a single duplex stream.
    const duplexStream = duplexer(childProc.stdin, childProc.stdout);
